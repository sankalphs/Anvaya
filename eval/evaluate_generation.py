"""Aggregate fixed-rubric answer judgments and deterministic claim-support counts."""
...
def main() -> None:
    ...
    cases = [case for case in all_cases if case["expected"]["route"] == ANSWER_ROUTE]
    pairs = pair_cases_and_predictions(cases, read_jsonl(args.predictions))
    metrics, details = evaluate_generation_records(pairs)
